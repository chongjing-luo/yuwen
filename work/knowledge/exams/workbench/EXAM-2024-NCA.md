...
- 题卷源ID：SRC-GK-2024-NCA-QUESTION；答案源ID：SRC-GK-2024-NCA-ANSWER
- 题卷文件：`Data/reference/gaokao/pdf/2024/2024_NCA_question.pdf`
- MinerU结果：`Data/reference/gaokao/mineru_result/2024_NCA_question`
- 题卷首段锚点：缺少可核验题卷正文。
