#!/usr/bin/env python3
"""Validate the core language-use candidate batch."""
...
BATCH = ROOT / "work/knowledge/exams/workbench/kp_batches/core_language_use_2009_2015.jsonl"
REPORT = ROOT / "work/knowledge/_meta/core_language_use_kp_batch_validation_20260809.json"
...
def main() -> int:
    ...
    for type_name in ("orthography", "word_usage", "sentence_grammar"):
    ...
    result = {
        "schema_version": "core-language-use-kp-batch-validation-0.1",
        "result": "passed" if not errors else "failed",
        "row_count": len(rows),
        "type_counts": dict(type_counts),
        "errors": errors,
        "checks": {
            "coverage": len(rows) == 21 and all(type_counts[t] == 7 for t in ("orthography", "word_usage", "sentence_grammar")),
