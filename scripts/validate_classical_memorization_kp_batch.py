#!/usr/bin/env python3
"""Validate the classical memorization candidate batch."""
...
BATCH = ROOT / "work/knowledge/exams/workbench/kp_batches/classical_memorization_2009_2015.jsonl"
REPORT = ROOT / "work/knowledge/_meta/classical_memorization_kp_batch_validation_20260809.json"
...
def main() -> int:
    ...
    result = {
        "schema_version": "classical-memorization-kp-batch-validation-0.1",
        ...
        "checks": {
            ...
            "fill_in_gate": not any("auto-extracted" in error for error in errors),
