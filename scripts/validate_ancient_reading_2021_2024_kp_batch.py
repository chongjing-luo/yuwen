#!/usr/bin/env python3
"""Validate the 2021--2024 ancient-reading candidate batch."""
...
BATCH = ROOT / "work/knowledge/exams/workbench/kp_batches/ancient_reading_2021_2024.jsonl"
REPORT = ROOT / "work/knowledge/_meta/ancient_reading_2021_2024_kp_batch_validation_20260809.json"
...
def main() -> int:
    ...
    for row in rows:
        ...
        if row.get("response_form") != "objective_ancient_reading":
    ...
    result = {
        "schema_version": "ancient-reading-2021-2024-kp-batch-validation-0.1",
        ...
        "checks": {
            ...
            "answer_gate": not any("auto-extracted" in error or "review gate" in error for error in errors),
