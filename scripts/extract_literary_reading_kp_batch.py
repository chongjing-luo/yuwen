...
def render(rows: list[dict]) -> str:
    ...
    lines += [
        ...
        "| 产物 | 路径 |",
        "|---|---|",
        "| JSONL | `work/knowledge/exams/workbench/kp_batches/literary_reading_2009_2015.jsonl` |",
        "| 本报告 | `work/knowledge/exams/workbench/kp_batches/literary_reading_2009_2015.md` |",
